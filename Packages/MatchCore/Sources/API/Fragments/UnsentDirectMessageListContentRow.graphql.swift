...
public extension API {
  struct UnsentDirectMessageListContentRow: API.SelectionSet, Fragment {
    public static var fragmentDefinition: StaticString {
      #"fragment UnsentDirectMessageListContentRow on Match { __typename id isRead createdAt targetUser { __typename id status displayName externalProductUrl images { __typename id imageUrl } } }"#
    }
