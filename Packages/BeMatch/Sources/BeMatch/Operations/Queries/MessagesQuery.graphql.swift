...
public extension BeMatch {
  class MessagesQuery: GraphQLQuery {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query Messages($targetUserId: ID!, $first: Int!, $after: String) { messages(targetUserId: $targetUserId, first: $first, after: $after) { __typename pageInfo { __typename hasNextPage endCursor } edges { __typename node { __typename id text userId createdAt } } } }"#
      ))
