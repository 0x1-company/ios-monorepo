...
public extension FlyCam {
  class CreateFirebaseRegistrationTokenMutation: GraphQLMutation {
    ...
    public struct Data: FlyCam.SelectionSet {
      ...
      public struct CreateFirebaseRegistrationToken: FlyCam.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { FlyCam.Objects.FirebaseRegistrationToken }
        public static var __selections: [ApolloAPI.Selection] { [
