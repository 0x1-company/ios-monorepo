  ...
  var body: some View {
    VStack(spacing: 24) {
      VStack(spacing: 8) {
        ...
        Text("Send an invitation code to a friend who hasn't used TapMatch", bundle: .module)
      }
      ...
      VStack(spacing: 8) {
        ...
        Text("When they enter the Invitation Code and register, you will both receive TapMatch PRO for sure!", bundle: .module)
      }
