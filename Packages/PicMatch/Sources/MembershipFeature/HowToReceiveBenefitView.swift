  ...
  var body: some View {
    VStack(spacing: 24) {
      VStack(spacing: 8) {
        ...
        Text("Send an invitation code to a friend who hasn't used PicMatch", bundle: .module)
      }
      ...
      VStack(spacing: 8) {
        ...
        Text("When they enter the Invitation Code and register, you will both receive PicMatch PRO for sure!", bundle: .module)
      }
